jQuery(function ($) {
    $("#mnotifysms_setting\\[mnotifysms_woocommerce_sms_from\\]").focusout(function() {
        var sender_id = $("#mnotifysms_setting\\[mnotifysms_woocommerce_sms_from\\]").val().trim();
        ...
        $("#mnotifysms_setting\\[mnotifysms_woocommerce_sms_from\\]").val(sender_id);        
    });
    
    $("#admin_setting\\[mnotifysms_woocommerce_admin_sms_recipients\\]").focusout(function() {
        var admin_mobile_no = $("#admin_setting\\[mnotifysms_woocommerce_admin_sms_recipients\\]").val().trim();
